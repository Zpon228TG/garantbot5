...
class Config(BaseSettings):
    ...
    API_ID: int
    API_HASH: str
    USER_SUBSCRIBE_CHANNEL_ID: int = None
    USER_SUBSCRIBE_CHANNEL_LINK: str = None

    DAY_1_SUBSCRIPTION_PRICE: int = None
    DAY_30_SUBSCRIPTION_PRICE: int = None
    DAY_90_SUBSCRIPTION_PRICE: int = None
    DAY_365_SUBSCRIPTION_PRICE: int = None
